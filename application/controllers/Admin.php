...
class Admin extends CI_Controller
{
    ...
    function admin($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == 'create') {
            ...
            $data['conc'] = "$name " . "$phone ";
            $data['name'] . $data['phone'] = $this->input->post('conc');
    ...
    function student($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            if ($this->input->post('birth_certificate_number') != null) {
                $data['birth_certificate_number'] = $this->input->post('birth_certificate_number');
            }
            ...
            if ($this->input->post('county_id') != null) {
    ...
    function parent($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            if ($this->input->post('alt_phone') != null) {
    ...
    function get_parents()
    {
        ...
        if (!empty($parents)) {
            foreach ($parents as $row) {
                ...
                $nestedData['first_name'] = $row->first_name . " " . $row->l_name;
                $nestedData['id_number'] = $row->id_number;
                $nestedData['email'] = $row->email;
                $nestedData['phone'] = $row->phone;
                $nestedData['alt_phone'] = $row->alt_phone;
    ...
    function sections($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            if ($validation == 1) {
                ...
                $this->session->set_flashdata('flash_message', get_phrase('stream_added_successfully'));
            } else {
                $this->session->set_flashdata('error_message', get_phrase('session_name_already_available'));
            }
    ...
    {
        $sections = $this->db->get_where('subcounty', array(
            'county_id' => $county_id
        ))->result_array();
        foreach ($subcounties as $row) {
            echo '<option value="' . $row['subcounty_id'] . '">' . $row['name'] . '</option>';
        }
    }
    ...
    function grade($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message', get_phrase('grade_added_successfully'));
    ...
    function class_routine($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            if ($validation == 1) {
                ...
                $this->session->set_flashdata('flash_message', get_phrase('class routine_added_successfully'));
            } else {
    ...
    function invoice($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message', get_phrase('invoice_added_successfully'));
        ...
        if ($param1 == 'create_mass_invoice') {
            ...
            $this->session->set_flashdata('flash_message', get_phrase('mass_invoice_added_successfully'));
            redirect(site_url('admin/student_payment'), 'refresh');
        }
    ...
    function expense($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->db->insert('payment', $data);
            $this->session->set_flashdata('flash_message', get_phrase('expense_added_successfully'));
    ...
    function expense_category($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message', get_phrase('expense_category_added_successfully'));
    ...
    function transport($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message', get_phrase('transport_added_successfully'));
    ...
    function dormitory($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message', get_phrase('dormitory_added_successfully'));
    ...
    function noticeboard($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message', get_phrase('notice_added_successfully'));
    ...
    function librarian($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            if ($validation == 1) {
                ...
                $this->session->set_flashdata('flash_message', get_phrase('librarian_added_successfully'));
