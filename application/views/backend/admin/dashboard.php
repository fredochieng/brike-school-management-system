...
<div class="row">
    ...
    <div class="col-sm-3 col-xs-6">
        ...
        <div class="tile-stats tile-green">
            ...
            <div class="num" data-start="0" data-end="<?php echo $this->db->count_all('teacher'); ?>" data-postfix=""
                data-duration="800" data-delay="0">0</div>
    ...
    <div class="col-sm-3 col-xs-6">
        ...
        <div class="tile-stats tile-aqua">
            ...
            <div class="num" data-start="0" data-end="<?php echo $this->db->count_all('parent'); ?>" data-postfix=""
                data-duration="500" data-delay="0">0</div>
    ...
    <div class="col-sm-3 col-xs-6">
        ...
        <div class="tile-stats tile-blue">
            ...
            ?>
            <div class="num" data-start="0" data-end="<?php echo $present_today; ?>" data-postfix="" data-duration="500"
                data-delay="0">0</div>
