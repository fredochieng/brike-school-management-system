            ...
            <li class="active">
                <a href="#home" data-toggle="tab">
                    ...
                    <span class="hidden-xs">
                        <?php echo get_phrase('all_students'); ?></span>
                </a>
            </li>
            <?php
                ...
                <table class="table table-bordered datatable">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <div>
                                    <?php echo get_phrase('stream'); ?>
                                </div>
                            </th>
                            <th>
                                <div>
                                    <?php echo get_phrase('county'); ?>
                                </div>
                            </th>
                            <th>
                                <div>
                                    <?php echo get_phrase('subcounty'); ?>
                                </div>
                            </th>
                            <th>
                                <div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $this->db->get_where('student', array(
                                    'student_id' => $row['student_id']
                                ))->row()->student_code; ?>
                            </td>
                            <td>
                                <?php
                                echo $row['name'] . " " . $row['middle_name'] . " " . $row['last_name'];
                                ?>
                            </td>
                            <td>
                                <?php
                            ...
                            <td>
                                <?php
                                $row['county_id'] == null ? '' : $this->db->get_where('county', array('county_id' => $row['county_id']))->row()->name
                                ?>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                            <a
                                                href="<?php echo site_url('admin/student_marksheet/' . $row['student_id']); ?>">
                                        ...
                                        <li>
                                            <a
                                                href="<?php echo site_url('admin/student_profile/' . $row['student_id']); ?>">
                                        ...
                                        <li>
                                            <a href="#"
                                                onclick="showAjaxModal('<?php echo site_url('modal/popup/modal_student_edit/' . $row['student_id']); ?>');">
                                        ...
                                        <li>
                                            <a href="#"
                                                onclick="confirm_modal('<?php echo site_url('admin/delete_student/' . $row['student_id'] . '/' . $class_id); ?>');">
                ...
                <table class="table table-bordered datatable">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <div>
                                    <?php echo get_phrase('email') . '/' . get_phrase('username'); ?>
                                </div>
                            </th>
                            <th>
                                <div>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                            <a href="#"
                                                onclick="showAjaxModal('<?php echo site_url('modal/popup/modal_student_profile/' . $row['student_id']); ?>');">
                                                <i class="entypo-user"></i>
                                                <?php echo get_phrase('profile'); ?>
                                            </a>
                                        </li>
