    <script type="text/javascript">
        function showAjaxModal(url) {
            ...
            jQuery('#modal_ajax .modal-body').html(
                '<div style="text-align:center;margin-top:200px;"><img src="assets/images/preloader.gif" /></div>');
    ...
    <div class="modal fade" id="modal_ajax">
        <div class="modal-dialog" style="width:70%; margin-left:25%;margin-top:3.5%;">
    ...
    <script type="text/javascript">
        function confirm_modal(delete_url, modal_type) {
            if (modal_type === 'generic_confirmation') {
                jQuery('#modal-generic_confirmation').modal('show', {
                    backdrop: 'static'
                });
            ...
            <div class="modal-content" style="margin-top:100px;">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" style="text-align:center;">
                        <?php echo get_phrase('are_you_sure_to_update_this_information'); ?> ?</h4>
                </div>
                ...
                <div class="modal-footer" style="margin:0px; border-top:0px; text-align:center;">
                    ...
                    <button type="button" class="btn btn-info"
                        data-dismiss="modal"><?php echo get_phrase('no'); ?></button>
                </div>
            </div>
        </div>
    </div>